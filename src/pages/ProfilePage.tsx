...
export const ProfileScreen = () => {
    ...
    return (
        <div className="h-full w-full bg-slate-950 text-slate-100 overflow-y-auto custom-scrollbar p-4 md:p-8 pb-24">
            <div className="max-w-5xl mx-auto space-y-6">

                {/* Profile Header Card */}
                <div className="relative group rounded-3xl bg-slate-900/50 border border-white/5 overflow-hidden">
                    {/* Cover Image */}
                    <div className="h-48 w-full bg-gradient-to-r from-indigo-900/50 via-purple-900/50 to-slate-900/50 relative">
                        ...
                        <div className="absolute top-4 right-4">
                            <button
                                ...
                                className="p-2 bg-black/30 hover:bg-black/50 backdrop-blur-md rounded-full text-white transition-all border border-white/10 hover:scale-105 active:scale-95"
                            >
                    ...
                    <div className="px-6 pb-6 pt-0 relative flex flex-col md:flex-row items-start md:items-end gap-6 -mt-16">
                        ...
                        <div className="relative">
                            <div className="w-32 h-32 rounded-full border-4 border-slate-950 bg-slate-800 flex items-center justify-center shadow-2xl relative overflow-hidden group-hover:scale-[1.02] transition-transform duration-300">
                                {currentUser.avatar ? (
                        ...
                        <div className="flex-1 pt-14 md:pt-0">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div className="flex items-center gap-3">
                                    <button className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-medium shadow-lg shadow-indigo-500/20 transition-all active:scale-95 flex items-center gap-2">
                                        <Edit3 size={16} />
                                        Edit Profile
                                    </button>
                                    <button className="p-2 bg-white/5 hover:bg-white/10 text-slate-300 rounded-xl border border-white/5 transition-colors">
                                        <Share2 size={20} />
                                    </button>
                                </div>
                            </div>

                            <div className="flex flex-wrap gap-x-6 gap-y-2 mt-4 text-slate-400 text-sm">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {stats.map((stat, idx) => (
                        <div key={idx} className="bg-slate-900/50 border border-white/5 p-4 rounded-2xl hover:bg-white/5 transition-colors group">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {activeTab === 'overview' && (
                            <div className="bg-slate-900/30 border border-white/5 rounded-2xl p-6">
                                ...
                                <div className="mt-6">
                                    <h4 className="text-sm font-medium text-slate-300 mb-3 uppercase tracking-wider">Expertise</h4>
                                        ...
                                        <div key={item} className="flex gap-4 group">
                                            ...
                                            <div>
                                                <p className="text-slate-300 text-sm">
                                                    <span className="text-indigo-400 font-medium cursor-pointer hover:underline">Alex Morgan</span> closed a deal with <span className="text-white font-medium">TechFlow Inc.</span>
                                                </p>
                        ...
                        {activeTab === 'intents' && (
                            <div className="bg-slate-900/30 border border-white/5 rounded-2xl p-6">
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-lg font-semibold text-white">Completed Intents</h3>
                                    ...
                                    {[
                                        ...
                                        <div key={idx} className="flex items-center justify-between p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors border border-white/5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="text-slate-200 font-medium text-sm">{intent.title}</div>
                                                    <div className="text-slate-500 text-xs">{intent.date}</div>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                                <div className="text-white font-medium text-sm">{intent.value}</div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-900/30 border border-white/5 rounded-2xl p-5">
                            <h3 className="text-sm font-semibold text-white mb-4 uppercase tracking-wider">Information</h3>
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3 text-slate-400">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="text-sm text-slate-300">+1 (416) 555-0199</div>
                                    </div>
                                </div>
                            </div>
                        </div>
