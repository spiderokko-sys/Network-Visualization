...
export const ChatsModule = ({ selectedChatId, setSelectedChatId }: any) => {
	...
	return (
		<div className="p-4 space-y-4 animate-in fade-in h-full flex gap-4">
			{/* Chat List */}
			<div className={`glass-panel h-full flex flex-col rounded-2xl overflow-hidden shadow-2xl transition-all duration-300 ${selectedChatId ? 'hidden md:flex md:w-80 lg:w-96' : 'w-full'}`}>
